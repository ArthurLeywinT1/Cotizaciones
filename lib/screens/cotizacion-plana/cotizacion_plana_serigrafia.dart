        ...
        child: Column(
          ...
          children: [
              ...
              (index) {
                return Row(
                  children: [
                    ...
                    Expanded(
                      child: campo(
                        "Precio ${index + 1}",  // <-- Aquí se muestra el precio de cada marco esta en extras
            ...
            campo(
              ...
              readOnly: true,  // hacer formula de precio de marcos y sumar el ptecio de cada marco para que salga el total la dormula seria algo asi: (ancho .1 * alto .1) * precio por metro cuadrado  y sumas dependiendo de cuantos marcos haya ya esta el void de calcular total marcos nadamas hay que arreglarlo
            ),
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: campo(
                    "Precio Negativo",
                    widget.precioNegativoController, //precio de negativo va en extras y multiplicarlo por la cantidad de negativos para que salga el total de negativos
                  ),
                ),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: campo(
                    "Costo por Tinta",  // costo de tinta va en extras 
                    widget.costoTintasController,
                  ),
                ),
                const SizedBox(width: 10),
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: campo(
                    "Costo por Millar",   // costo por millar va en extras 
                    widget.costoMillarController,
                  ),
                ),
                const SizedBox(width: 10),
