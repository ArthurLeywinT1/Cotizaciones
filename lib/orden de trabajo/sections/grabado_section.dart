          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Text("8. GRABADO", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ],
            ),
            const Divider(),
            ...
            _buildInput(
              ...
              onChanged: (v) => ref.read(ordenTrabajoProvider).updateGrabado('proyecto', v)
            ),
              ...
              children: [
                Expanded(
                  ...
                  child: _buildInput(
                    ...
                    onChanged: (v) => ref.read(ordenTrabajoProvider).updateGrabado('placas', v)
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: _buildInput(
                    ...
                    "0", 
                    esNumero: true,
                    onChanged: (v) => ref.read(ordenTrabajoProvider).updateGrabado('piezas', v)
                  ),
                ),
              ],
            ),
            ...
            Wrap(
              ...
              children: [
                _buildCheck("Romosso", controller.grabadoEsRomosso, (v) => ref.read(ordenTrabajoProvider).updateGrabado('romosso', v!)),
                _buildCheck("Maquilador", controller.grabadoEsMaquilador, (v) => ref.read(ordenTrabajoProvider).updateGrabado('maquilador', v!)),
                ...
                if (controller.grabadoEsMaquilador)
                  SizedBox(
                    width: 250,
                    child: TextField(
                      onChanged: (v) => ref.read(ordenTrabajoProvider).updateGrabado('nombreMaquila', v),
            ...
            TextField(
              maxLines: 3, 
              onChanged: (v) => ref.read(ordenTrabajoProvider).updateGrabado('notas', v), 
              decoration: InputDecoration(
                hintText: "Escribe aquí cualquier instrucción adicional, cuidado especial, o detalle extra para el área de grabado...",
                isDense: true,
                filled: true,
