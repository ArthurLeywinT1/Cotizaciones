          ...
          children: [
            Row(
              children: [
                ...
                const Text("6. SUAJE", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ],
            ),
            const Divider(),
            ...
            Wrap(
              ...
              children: [
                _buildCheck("Romosso", controller.suajeEsRomosso, (v) => controller.updateSuaje('romosso', v!)),
                _buildCheck("Maquilador", controller.suajeEsMaquilador, (v) => controller.updateSuaje('maquilador', v!)),
                ...
                if (controller.suajeEsMaquilador)
                  SizedBox(
                    width: 250,
                    child: TextField(
                      onChanged: (v) => controller.updateSuaje('nombreMaquila', v),
            ...
            Row(
              children: [
                _buildCheck("Marco Existente", controller.suajeMarcoExistente, (v) => controller.updateSuaje('existente', v!)),
                _buildCheck("Marco Nuevo", controller.suajeMarcoNuevo, (v) => controller.updateSuaje('nuevo', v!)),
              ],
            ),
            ...
            TextField(
              maxLines: 3,
              onChanged: (v) => ref.read(ordenTrabajoProvider).updateSuaje('notas', v),
              decoration: InputDecoration(
                hintText: "Ej: instruciones para el suaje, tipo de marco, si es necesario reparar el marco existente...",
                isDense: true,
                filled: true,
