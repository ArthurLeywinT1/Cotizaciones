    ...
    try {
      await db.execute(
        '''INSERT INTO maquinas (
             ...
             ancho_maximo, largo_maximo, costo_por_placa
           ) VALUES (@nom, @tintas, @tamanos, @ancho, @largo, @costo)''',
        params: {
          'nom': maquina.nombre,
      ...
      await db.execute(
        '''UPDATE maquinas 
           SET nombre_maquina = @nom, cantidad_tintas = @tintas, 
               ...
               largo_maximo = @largo, costo_por_placa = @costo, 
