...
class CotizacionService {
  ...
  Future<void> crearCotizacion(Cotizacion cotizacion) async {
    try {
      await db.execute('''INSERT INTO cotizaciones (
            ...
            precio_sin_iva, precio_unitario, precio_con_iva, status, tipo_cotizacion, num_pliegos,
  ...
  Future<void> actualizarCotizacion(Cotizacion cotizacion) async {
    if (cotizacion.id == null || cotizacion.id!.isEmpty) {
      throw ArgumentError('No se puede actualizar una cotización sin ID.');
    }
